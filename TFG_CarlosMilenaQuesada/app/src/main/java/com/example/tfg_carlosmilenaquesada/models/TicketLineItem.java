...
public class TicketLineItem extends TicketLine {
    private String article_name;
    private float unit_sale_base_price;
    private String is_in_offer;
    ...
    public TicketLineItem(String ticket_line_id, String ticket_id, String article_id, String article_name, float article_quantity, float unit_sale_base_price, String is_in_offer, float vat_fraction) {
        super(ticket_line_id, ticket_id, article_id, article_quantity);
